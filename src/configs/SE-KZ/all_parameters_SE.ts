...
export const SEKZ_randoms_allParameters: analyticsConfigType = {
  ...
  id_key: "ID",
  pointsCsvPath: "./src/static/Random_forest/SE-KZ/randompoints-se-kz.csv",
...
export const SEKZ_neophronPresence_allParameters: analyticsConfigType = {
  ...
  longitude_key: "X_coord",
  id_key: "Name",
  pointsCsvPath: "./src/static/Random_forest/SE-KZ/NP-SE-KZ.csv",
...
export const SEKZ_absence_allParameters: analyticsConfigType = {
  ...
  longitude_key: "X_coord",
  id_key: "ID",
  pointsCsvPath: "./src/static/Random_forest/SE-KZ/Points-withoutNP-SE-KZ.csv",
